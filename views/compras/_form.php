...
<div class="compras-form">
  ...
  <div class="panel panel-default">
        <div class="panel-heading">
            <h4><i class="glyphicon glyphicon-envelope"></i> Comprado</h4></div>
                                     ...
                                     'onchange' => '$.get( "'.Url::toRoute('/productos/productoajax').'", { clave:$(this).val(), nitem:$(this).attr("id").replace(/[^0-9.]/g, "") } )
                                                .done(function( data ) {
                                                    if(data.error) {
                                                        ...
                                                        $("#comprado-" + data.nitem + "-precio_unitario").val(data.precio);
                                                        $("#comprado-" + data.nitem + "-importe").val(data.precio);
                                                    }
                                                }
                                            );'
                                ]
